...
/**
 * Request DTO for creating a new Political Party
 */
@Data
public class CreatePoliticalPartyRequestDto {

    @NotBlank(message = "Political party name is required")
    @Size(min = 2, max = 200, message = "Political party name must be between 2 and 200 characters")
    private String name;

    @NotBlank(message = "Political party abbreviation is required")
